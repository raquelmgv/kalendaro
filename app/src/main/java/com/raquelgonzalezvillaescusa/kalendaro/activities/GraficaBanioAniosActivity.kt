...
import kotlinx.android.synthetic.main.activity_grafica_banio_anios.*


class GraficaBanioAniosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_grafica_banio_anios)
        displayConceptualMenu()
        toolbar = findViewById(R.id.toolbar)
        setUpToolbar(toolbar)
        grafica = findViewById(R.id.graficaBanioAnios)
        labelsX = setLabelsX()
