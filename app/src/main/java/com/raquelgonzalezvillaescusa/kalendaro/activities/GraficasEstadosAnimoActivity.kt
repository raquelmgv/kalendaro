...
import kotlinx.android.synthetic.main.activity_graficas_estados_animo.*


class GraficasEstadosAnimoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_graficas_estados_animo)
