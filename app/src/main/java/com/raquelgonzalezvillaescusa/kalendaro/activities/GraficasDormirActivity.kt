...
import kotlinx.android.synthetic.main.activity_graficas_dormir.*


class GraficasDormirActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_graficas_dormir)
        displayConceptualMenu()
        toolbar = findViewById(R.id.toolbar)
        setUpToolbar(toolbar)

        button_graficaMesActual.setOnClickListener {
            goToActivity<GraficaDormirMesActivity>()
        }
        button_graficaMeses.setOnClickListener {
            goToActivity<GraficaDormirMesesActivity>()
        }
        button_graficaAnios.setOnClickListener {
            goToActivity<GraficaDormirAniosActivity>()
        }
