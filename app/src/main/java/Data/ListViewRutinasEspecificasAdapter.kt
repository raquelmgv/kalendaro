...
class ListViewRutinasEspecificasAdapter(private val mContext: Context, private val rutinasList: MutableList<String>, private val categoriaRutina: MutableList<String>): ArrayAdapter<String>(mContext, 0, rutinasList) {
    /*1*/
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        /*3*/
        var fotoRutinaPath = "$currentUser/images/rutinas/cat_${categoriaRutina[position]}/rut_$rutina"
